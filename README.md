...
This project implements a reusable GetRequester class for retrieving remote data from an API.
...
load_json()
Converts the response body into Python data structures using JSON parsing.
